...
URL slug: `/support/users/clicking-a-map-marker`

## What this article covers
This guide explains how **clicking a map marker** in The Greek Directory based on the current site behavior documented in the project README.
