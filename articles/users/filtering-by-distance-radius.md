...
URL slug: `/support/users/filtering-by-distance-radius`

## What this article covers
This guide explains how **filtering by distance (radius)** in The Greek Directory based on the current site behavior documented in the project README.
