...
URL slug: `/support/users/business-hours-and-openclosed-status`

## What this article covers
This guide explains how **business hours & open/closed status** in The Greek Directory based on the current site behavior documented in the project README.
