# Using Split View (Map + List Side by Side)

URL slug: `/support/users/using-split-view-map-list-side-by-side`

## What this article covers
This guide explains how **using split view (map + list side by side)** in The Greek Directory based on the current site behavior documented in the project README.
