...
URL slug: `/support/users/navigating-with-the-dock`

## What this article covers
This guide explains how **navigating with the dock** in The Greek Directory based on the current site behavior documented in the project README.
