# Filtering by Pricing

URL slug: `/support/users/filtering-by-pricing`

## What this article covers
This guide explains how **filtering by pricing** in The Greek Directory based on the current site behavior documented in the project README.
