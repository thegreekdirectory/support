...
URL slug: `/support/users/browser-and-device-compatibility`

## What this article covers
This guide explains how **browser & device compatibility** in The Greek Directory based on the current site behavior documented in the project README.
