# Filtering by Hours (Open Now, Closing Soon, etc.)

URL slug: `/support/users/filtering-by-hours-open-now-closing-soon-etc`

## What this article covers
This guide explains how **filtering by hours (open now, closing soon, etc.)** in The Greek Directory based on the current site behavior documented in the project README.
