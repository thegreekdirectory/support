...
URL slug: `/support/users/using-the-map-view`

## What this article covers
This guide explains how **using the map view** in The Greek Directory based on the current site behavior documented in the project README.
