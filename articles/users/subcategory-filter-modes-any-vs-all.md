# Subcategory Filter Modes: Any vs. All

URL slug: `/support/users/subcategory-filter-modes-any-vs-all`

## What this article covers
This guide explains how **subcategory filter modes: any vs. all** in The Greek Directory based on the current site behavior documented in the project README.
