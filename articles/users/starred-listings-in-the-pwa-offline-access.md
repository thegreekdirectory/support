# Starred Listings in the PWA (Offline Access)

URL slug: `/support/users/starred-listings-in-the-pwa-offline-access`

## What this article covers
This guide explains how **starred listings in the pwa (offline access)** in The Greek Directory based on the current site behavior documented in the project README.
