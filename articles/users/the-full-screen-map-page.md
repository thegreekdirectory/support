# The Full-Screen Map Page

URL slug: `/support/users/the-full-screen-map-page`

## What this article covers
This guide explains how **the full-screen map page** in The Greek Directory based on the current site behavior documented in the project README.
