# Hard Refresh vs. Reset

URL slug: `/support/users/hard-refresh-vs-reset`

## What this article covers
This guide explains how **hard refresh vs. reset** in The Greek Directory based on the current site behavior documented in the project README.
