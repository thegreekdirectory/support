...
URL slug: `/support/users/using-the-app-offline`

## What this article covers
This guide explains how **using the app offline** in The Greek Directory based on the current site behavior documented in the project README.
