...
URL slug: `/support/users/installing-on-iphone-ios`

## What this article covers
This guide explains how **installing on iphone (ios)** in The Greek Directory based on the current site behavior documented in the project README.
